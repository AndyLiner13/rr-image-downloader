...
export interface ElectronAPI {
  ...
  selectMyRoomsJson: () => Promise<string | null>;
  ...
  removeProgressListener: (
    callback: (event: unknown, progress: Progress) => void
  ) => void;
