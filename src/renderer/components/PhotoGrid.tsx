...
const PhotoGridComponent: React.FC<PhotoGridProps> = ({
  ...
  }, [photos, sortBy, getCheersCount, getCommentsCount, useProvidedOrder]);
  ...
  const filteredPhotos = useMemo(() => {
    ...
    return searchIndex
      ...
      .map(({ photo }) => photo);
  }, [searchIndex, sortedPhotos, deferredSearchQuery, useProvidedOrder]);
